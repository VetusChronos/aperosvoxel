...
const GRAVITY : Vector3 = Vector3(0, -14, 0)
...
var _rotation_axis : Vector3 = Vector3()
var _angular_velocity : float = 4.0 * TAU * randf_range(-1.0, 1.0)
var _remaining_time : float = randf_range(0.5, 1.5) * LIFETIME
